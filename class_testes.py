class Grafos(): #  classe dos grafos
    ...
    def exibir_grafo(grafo): #exibir grafo
...
class Dgrafo(): #  classe dos dgrafos
    ...
    def ler_dgrafo_entrada_ad(): #  ler as informações de entrada dos dgrafo
        ...
        print("\n\033[1;35mDgrafo entrada\033[0m\n")
    ...
    def exibir_dgrafo(dgrafo_entrada, dgrafo_saida ): #  exibir dgrafo  
    
        print('\n\033[1;33mTabela dgrafos entrada\033[0m\n')
        ...
        print('\n\033[1;33mTabela dgrafos saída\033[0m\n')
